...
const PlaceORder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      {/* -------------------left-side------------------------ */}
      <div className="fkex fkex-col gap-4 w-full sm:max-w-[480px]">
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="gap-3 grid grid-cols-1 lg:grid-cols-[1fr_1fr] ">
            ...
            <div onClick={() => setMethod('razorpay')} className="flex items-center gap-3 border w-full p-2 px-3 cursor-pointer">
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>
              <img className="h-5" src={assets.razorpay_logo} />
            </div>
