...
const Product = () => {
  ...
  return productData ? (
    <div className="border-t-2 pt-10 trasistion-opacity ease-in duration-500 opacity-100">
      {/*______________________ product data?/ */}
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mt-2">
            <img alt="" src={assets.star_icon} className="w-3 5" />
            <img alt="" src={assets.star_icon} className="w-3 5" />
            <img alt="" src={assets.star_icon} className="w-3 5" />
            <img alt="" src={assets.star_icon} className="w-3 5" />
      ...
      {/* _____________________- Description and Review Section --------------------------- */}
      <div className="mt-20">
        <div className="flex">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500">
          <p>An ecommerce website is on nline platform that facilicated the buying and selling of goods and serbice between users and the platform online. it is also an online marketplace for easy exchange of products for cash.</p>
          <p>An ecommerce website is on nline platform that facilicated the buying and selling of goods and serbice between users and the platform online. it is also an online marketplace for easy exchange of products for cash.</p>
        </div>
      </div>
