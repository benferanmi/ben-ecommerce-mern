        ...
        <div>
            ...
            <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-20">
                ...
                <div className="flex flex-col justify-center items-start gap-6">
                    ...
                    <p className="text-gray-500">200213 williams Station <br /> Suite 350, Banana island Lagos</p>
                    <p className="text-gray-500">Tel: (+234) 8125291401 <br /> Email: benferanmiopafunso@gmail.com</p>
